...
Public Class frm_SDQC001 : Inherits jp.co.ait.common.forms.ABCDBCForm

#Region " VARIABLE / CONSTANT "

    Private SDQC001 As frm_SDQC001
    Private SDQC002 As frm_SDQC002
...
#Region " MENTHODS "
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frm_SDQC001_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            WriteEventStartLog("frm_SDQC001_Load")
        ...
        Catch ex As Exception
            ...
            End If
        Finally
            WriteEventEndLog("frm_SDQC001_Load")
        End Try
    End Sub
    ...
    Private Sub exeBarcodeInput()
        Try
            ...
            Dim ds As DataSet = webService.ChkStkDelBarcodeExist(barcodeObj.StrCodedata, "W900", BCLoginManager.GetLoginInfo.UserID)
            ' result
            ...
            If result = 0 Then ' check success
                ...
                ' import barcode
                webService.StockDeleteW900(barcodeObj.StrCodedata, itemCd, rackNo, BCLoginManager.GetLoginInfo.UserID)
            ...
            ElseIf result = 2 Then
                ...
                End If
                'barcodeObj.ScanDisable()
                ShowMessageForm("ERR124", "Stock Delete Error")
                Me.Focus()
                msgListener = New MessageListener(Me)
            End If
        Catch ex As Exception
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frm_SDQC001_Closing(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Try
            WriteEventStartLog("frm_SDQC001_Closing")
            'Free memmory
            'barcodeObj.ScanDisable()
            ' Dispose listener
            If Not Me.msgListener Is Nothing Then
        ...
        Catch ex As Exception
            ...
            End If
        Finally
            WriteEventEndLog("frm_SDQC001_Closing")
        End Try
    End Sub
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frm_SDQC001_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
