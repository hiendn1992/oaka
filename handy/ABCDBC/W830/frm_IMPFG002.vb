...
#Region " CONSTRUCTOR "
    ...
    Public Sub New(ByVal BarCode As String, _
        ...
        Me.lbl_warehouseCd.Text = GetMessage("MSG154", New String() {"W900", "W830"})
...
#Region " MENTHODS "
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub pnl_IMPFG002_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_imp.Click
        Try
            ...
            ' import barcode
            'webService.ImportFGBarcodeIntoQC(barCode, BCLoginManager.GetLoginInfo.UserID, itemCode)
            ...
            frm_imp003 = New frm_IMPFG003(message)
            frm_imp003.Show()
            Me.Close()
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frm_IMPFG002_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
        If e.KeyCode = Keys.F2 Then
            ' close curren form
            pnl_Return_Click(sender, e)
        ElseIf e.KeyCode = Keys.F1 Then
            pnl_IMPFG002_Click(sender, e)
