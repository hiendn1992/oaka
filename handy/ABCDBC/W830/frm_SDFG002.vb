...
#Region " MENTHODS "
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub pnl_SDFG002_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_imp.Click
        Try
            WriteEventStartLog("pnl_SDFG002_Click")
            ...
            sdfg003 = New frm_SDFG003(message)
            sdfg003.Show()
            Me.Close()
        Catch ex As Exception
            ...
            End If
        Finally
            WriteEventEndLog("pnl_SDFG002_Click")
        End Try
    End Sub
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frm_SDFG002_Closing(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
